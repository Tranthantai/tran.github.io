...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control <?php $__errorArgs = ['promotion_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="promotion_price" name="promotion_price">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <select class="form-control <?php $__errorArgs = ['new'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="new" id="new">
...
<a href="<?php echo e(route('banhang.index-show')); ?>" class="btn btn-secondary">Quay lại danh sách</a>
        </form>
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\tenproject\resources\views/admin/them.blade.php ENDPATH**/ ?>