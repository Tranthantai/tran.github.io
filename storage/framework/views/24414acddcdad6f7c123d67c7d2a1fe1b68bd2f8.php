		...
		<div id="content" class="space-top-none">
			...
			<div class="row">
				<div class="col-sm-8">
					...
					<div class="space20">&nbsp;</div>
					<form action="<?php echo e(route('showForm')); ?>" method="post" class="contact-form">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tenproject\resources\views/contact.blade.php ENDPATH**/ ?>