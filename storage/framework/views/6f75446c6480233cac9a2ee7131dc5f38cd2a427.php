		...
		<div class="header-bottom" style="background-color: #0277b8;">
			<div class="container">
				...
				<nav class="main-menu">
					...
					<li><a href="<?php echo e(route('banhang.index-show')); ?>">Trang chủ</a></li>
						<li><a href="<?php echo e(route('showForm')); ?>">Sản phẩm</a>
							<ul class="sub-menu">
						...
						<li><a href="<?php echo e(route('showForm')); ?>">Liên hệ</a></li>
					</ul>
					<div class="clearfix"></div>
				</nav>
			</div> <!-- .container -->
		</div> <!-- .header-bottom -->
	</div> <!-- #header --><?php /**PATH C:\xampp\htdocs\tenproject\resources\views/layout/header.blade.php ENDPATH**/ ?>